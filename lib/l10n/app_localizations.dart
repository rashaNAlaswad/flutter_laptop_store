...
abstract class AppLocalizations {
  ...
  /// No description provided for @newLaptops.
  ///
  /// In en, this message translates to:
  /// **'New Laptops'**
  String get newLaptops;
  ...
  /// No description provided for @faildSnackbarTitle.
  ///
  /// In en, this message translates to:
  /// **'Sorry'**
  String get faildSnackbarTitle;

  /// No description provided for @faildSnackbarMessage.
  ///
  /// In en, this message translates to:
